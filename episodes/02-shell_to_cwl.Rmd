...
```yaml
`r xfun::file_string('files/echo.cwl')`
```
...
```yaml
`r xfun::file_string('files/hello_world.yml')`
```
...
```yaml
`r xfun::file_string('files/echo_with_stdout.cwl')`
```
...
```yaml
`r xfun::file_string('files/rna_seq_workflow_1.cwl')`
```
